...
class effect : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst16 = std::floor(((0.0316039994f * fConst0) + 0.5f));
		...
		fConst20 = std::floor(((0.219990999f * fConst0) + 0.5f));
		...
		fConst62 = std::floor(((0.256891012f * fConst0) + 0.5f));
		...
		fConst73 = std::floor(((0.0273330007f * fConst0) + 0.5f));
		...
		fConst76 = std::floor(((0.192303002f * fConst0) + 0.5f));
		...
		fConst87 = std::floor(((0.0292910002f * fConst0) + 0.5f));
		...
		fConst90 = std::floor(((0.210389003f * fConst0) + 0.5f));
		...
		fConst101 = std::floor(((0.0244210009f * fConst0) + 0.5f));
		...
		fConst104 = std::floor(((0.125f * fConst0) + 0.5f));
		...
		fConst115 = std::floor(((0.0134579996f * fConst0) + 0.5f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec11[0] = (0.0f - (fConst14 * ((fConst15 * fRec11[1]) - (fRec2[1] + fRec2[2]))));
			fRec10[0] = ((fConst10 * fRec10[1]) + (fConst11 * (fRec2[1] + (fConst12 * fRec11[0]))));
			...
			fRec8[0] = fVec2[((IOTA - iConst19) & 4095)];
			float fRec9 = (0.600000024f * fTemp2);
			fRec15[0] = (0.0f - (fConst14 * ((fConst15 * fRec15[1]) - (fRec7[1] + fRec7[2]))));
			fRec14[0] = ((fConst28 * fRec14[1]) + (fConst29 * (fRec7[1] + (fConst30 * fRec15[0]))));
			fVec3[(IOTA & 32767)] = ((0.353553385f * fRec14[0]) + 9.99999968e-21f);
			float fTemp3 = float(input1[i]);
			fVec4[(IOTA & 16383)] = fTemp3;
			float fTemp4 = (0.300000012f * fVec4[((IOTA - iConst18) & 16383)]);
			float fTemp5 = (((0.600000024f * fRec12[1]) + fVec3[((IOTA - iConst32) & 32767)]) - fTemp4);
			fVec5[(IOTA & 2047)] = fTemp5;
			fRec12[0] = fVec5[((IOTA - iConst33) & 2047)];
			...
			float fTemp6 = ((fTemp1 + fVec6[((IOTA - iConst46) & 16383)]) - (0.600000024f * fRec16[1]));
			fVec7[(IOTA & 2047)] = fTemp6;
			fRec16[0] = fVec7[((IOTA - iConst47) & 2047)];
			float fRec17 = (0.600000024f * fTemp6);
			...
			float fTemp7 = ((fVec8[((IOTA - iConst60) & 16383)] + fTemp1) - (0.600000024f * fRec20[1]));
			fVec9[(IOTA & 2047)] = fTemp7;
			fRec20[0] = fVec9[((IOTA - iConst61) & 2047)];
			float fRec21 = (0.600000024f * fTemp7);
			fRec27[0] = (0.0f - (fConst14 * ((fConst15 * fRec27[1]) - (fRec3[1] + fRec3[2]))));
			fRec26[0] = ((fConst70 * fRec26[1]) + (fConst71 * (fRec3[1] + (fConst72 * fRec27[0]))));
			fVec10[(IOTA & 32767)] = ((0.353553385f * fRec26[0]) + 9.99999968e-21f);
			float fTemp8 = (((0.600000024f * fRec24[1]) + fVec10[((IOTA - iConst74) & 32767)]) - fTemp4);
			fVec11[(IOTA & 4095)] = fTemp8;
			fRec24[0] = fVec11[((IOTA - iConst75) & 4095)];
			float fRec25 = (0.0f - (0.600000024f * fTemp8));
			fRec31[0] = (0.0f - (fConst14 * ((fConst15 * fRec31[1]) - (fRec5[1] + fRec5[2]))));
			fRec30[0] = ((fConst84 * fRec30[1]) + (fConst85 * (fRec5[1] + (fConst86 * fRec31[0]))));
			fVec12[(IOTA & 16383)] = ((0.353553385f * fRec30[0]) + 9.99999968e-21f);
			float fTemp9 = (fVec12[((IOTA - iConst88) & 16383)] + (fTemp4 + (0.600000024f * fRec28[1])));
			fVec13[(IOTA & 4095)] = fTemp9;
			fRec28[0] = fVec13[((IOTA - iConst89) & 4095)];
			float fRec29 = (0.0f - (0.600000024f * fTemp9));
			fRec35[0] = (0.0f - (fConst14 * ((fConst15 * fRec35[1]) - (fRec1[1] + fRec1[2]))));
			fRec34[0] = ((fConst98 * fRec34[1]) + (fConst99 * (fRec1[1] + (fConst100 * fRec35[0]))));
			fVec14[(IOTA & 32767)] = ((0.353553385f * fRec34[0]) + 9.99999968e-21f);
			float fTemp10 = (fTemp4 + ((0.600000024f * fRec32[1]) + fVec14[((IOTA - iConst102) & 32767)]));
			fVec15[(IOTA & 4095)] = fTemp10;
			fRec32[0] = fVec15[((IOTA - iConst103) & 4095)];
			float fRec33 = (0.0f - (0.600000024f * fTemp10));
			fRec39[0] = (0.0f - (fConst14 * ((fConst15 * fRec39[1]) - (fRec6[1] + fRec6[2]))));
			fRec38[0] = ((fConst112 * fRec38[1]) + (fConst113 * (fRec6[1] + (fConst114 * fRec39[0]))));
			fVec16[(IOTA & 16383)] = ((0.353553385f * fRec38[0]) + 9.99999968e-21f);
			float fTemp11 = (fVec16[((IOTA - iConst116) & 16383)] - (fTemp1 + (0.600000024f * fRec36[1])));
			fVec17[(IOTA & 2047)] = fTemp11;
			fRec36[0] = fVec17[((IOTA - iConst117) & 2047)];
			float fRec37 = (0.600000024f * fTemp11);
			float fTemp12 = (fRec36[1] + fRec32[1]);
			float fTemp13 = (fRec28[1] + fTemp12);
			fRec0[0] = (fRec8[1] + (fRec12[1] + (fRec16[1] + (fRec20[1] + (fRec13 + (fRec25 + (fRec29 + (fRec33 + (fRec37 + (fRec9 + (fRec17 + (fRec21 + (fRec24[1] + fTemp13)))))))))))));
			float fTemp14 = (fRec32[1] + fRec28[1]);
			fRec1[0] = ((fRec8[1] + (fRec16[1] + (fRec20[1] + (fRec37 + (fRec9 + (fRec17 + (fRec21 + fRec36[1]))))))) - (fRec12[1] + (fRec13 + (fRec25 + (fRec29 + (fRec33 + (fTemp14 + fRec24[1])))))));
			fRec2[0] = ((fRec16[1] + (fRec20[1] + (fRec29 + (fRec33 + (fRec17 + (fRec21 + fTemp14)))))) - (fRec8[1] + (fRec12[1] + (fRec13 + (fRec25 + (fRec37 + (fRec9 + (fRec36[1] + fRec24[1]))))))));
			fRec3[0] = ((fRec12[1] + (fRec16[1] + (fRec20[1] + (fRec13 + (fRec25 + (fRec17 + (fRec21 + fRec24[1]))))))) - (fRec8[1] + (fRec29 + (fRec33 + (fRec37 + (fRec9 + fTemp13))))));
			float fTemp15 = (fRec36[1] + fRec28[1]);
			fRec4[0] = ((fRec8[1] + (fRec20[1] + (fRec25 + (fRec33 + (fRec9 + (fRec21 + (fRec32[1] + fRec24[1]))))))) - (fRec12[1] + (fRec16[1] + (fRec13 + (fRec29 + (fRec37 + (fRec17 + fTemp15)))))));
			fRec5[0] = ((fRec8[1] + (fRec12[1] + (fRec20[1] + (fRec13 + (fRec29 + (fRec9 + (fRec21 + fRec28[1]))))))) - (fRec16[1] + (fRec25 + (fRec33 + (fRec37 + (fRec17 + (fRec24[1] + fTemp12)))))));
			fRec6[0] = ((fRec12[1] + (fRec20[1] + (fRec13 + (fRec33 + (fRec37 + (fRec21 + fTemp12)))))) - (fRec8[1] + (fRec16[1] + (fRec25 + (fRec29 + (fRec9 + (fRec17 + (fRec28[1] + fRec24[1]))))))));
			fRec7[0] = ((fRec20[1] + (fRec25 + (fRec29 + (fRec37 + (fRec21 + (fRec24[1] + fTemp15)))))) - (fRec8[1] + (fRec12[1] + (fRec16[1] + (fRec13 + (fRec33 + (fRec9 + (fRec17 + fRec32[1]))))))));
			output0[i] = FAUSTFLOAT((fTemp0 + (0.074000001f * (fRec1[0] + fRec2[0]))));
			output1[i] = FAUSTFLOAT((fTemp3 + (0.074000001f * (fRec1[0] - fRec2[0]))));
			IOTA = (IOTA + 1);
			fRec11[1] = fRec11[0];
			fRec10[1] = fRec10[0];
			fRec8[1] = fRec8[0];
